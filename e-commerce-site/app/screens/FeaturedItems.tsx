...
export default function FeaturedItems() {
  return (
    <div className="w-full max-h-screen mt-32 mb-10">
        <div className="text-center">
            <h1 className="text-4xl font-extrabold text-center">Featured Collections</h1>
        ...
        <div className="mt-10 flex justify-center items-center">
            <div className="flex flex-col justify-center items-center">
                <img src="/images/feature1.png" alt="feature 1" className="w-3/5 rounded-4xl" />
             ...
             <div className="flex flex-col justify-center items-center">
                <img src="/images/feature2.png" alt="feature 1" className="w-3/5 rounded-4xl" />
             ...
             <div className="flex flex-col justify-center items-center">
                <img src="/images/feature3.png" alt="feature 1" className="w-3/5 rounded-4xl" />
